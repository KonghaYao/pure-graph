...
export const runnableConfigToCheckpoint = (config: RunnableConfig | null | undefined) => {
...
export const taskRunnableConfigToCheckpoint = (config: RunnableConfig | null | undefined) => {
    if (!config || !config.configurable || !config.configurable.thread_id) {
        return null;
    }
